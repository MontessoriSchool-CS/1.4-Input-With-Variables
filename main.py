...
name = "Dave"   #name is a variable to hold someones first name

print("Hi " + name + "! How are you today?") #Name ius used within the string
...
# Task 4 - Combine lines 'Do you like programming' and answer = input  so that it the input has a prompt in it.
